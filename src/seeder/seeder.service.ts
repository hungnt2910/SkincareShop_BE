...
export class SeederService implements OnModuleInit {
  ...
  async onModuleInit() {
    ...
    //  const skinTypeees = [{ type: 'Da thường' }, { type: 'Da dầu' }, { type: 'Da khô' }, { type: 'Da nhạy cảm' }]
    // for (const skinType of skinTypeees) {
    ...
    // const skinTypes = await this.skinTypeRepository.find(); // Fetch available skin types

    // if (categories.length === 0 || brandList.length === 0 || skinTypes.length === 0) {
    //   console.error('⚠️ Please insert some categories, brands, and skin types first!');
    //   return;
    // }

    // const skincareProducts = [
    //   { name: 'Klairs Supple Preparation Toner', brand: 'Klairs', category: 'Toner', price: 100000, stock: 50 },
    //   { name: 'COSRX Advanced Snail 96 Mucin Power Essence', brand: 'COSRX', category: 'Serum', price: 23.0, stock: 45 },
    //   { name: 'CeraVe Hydrating Facial Cleanser', brand: 'CeraVe', category: 'Cleanser', price: 129000, stock: 100 },
    //   { name: 'La Roche-Posay Toleriane Hydrating Gentle Cleanser', brand: 'La Roche-Posay', category: 'Cleanser', price: 129000, stock: 80 },
    //   { name: 'The Ordinary Niacinamide 10% + Zinc 1%', brand: 'The Ordinary', category: 'Serum', price: 159000, stock: 120 },
    //   { name: "L'Oréal Revitalift Hyaluronic Acid Serum", brand: "L'Oréal Paris", category: 'Serum', price: 159000, stock: 60 },
    //   { name: 'Neutrogena Hydro Boost Water Gel', brand: 'Neutrogena', category: 'Moisturizer', price: 159000, stock: 90 },
    //   { name: "Paula's Choice 2% BHA Liquid Exfoliant", brand: "Paula's Choice", category: 'Exfoliator', price: 179000, stock: 55 },
    //   { name: 'Olay Regenerist Micro-Sculpting Cream', brand: 'Olay', category: 'Moisturizer', price: 200000, stock: 70 },
    ...
    //   // Assign 1-3 random skin types to each product
    //   const randomSkinTypes = skinTypes
    //     .sort(() => 0.5 - Math.random()) // Shuffle the skin types array
    //     .slice(0, Math.floor(Math.random() * 3) + 1); // Select 1 to 3 skin types

    //   product.skinTypes = randomSkinTypes;

    //   products.push(product);
    // }

    // await this.productRepository.save(products);
    // console.log('✅ 100 Skincare Products with Images & Skin Types seeded successfully!');
    //   const quizData = [
    //     {
